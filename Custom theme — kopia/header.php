...
<div class="d-none d-lg-block bg-light bg-opacity-25 ">
  <div class="container-lg d-flex justify-content-between align-items-center text-sm border-bottom">
    <div class="top-nav d-flex gap-4">
        <?php
        wp_nav_menu([
            'theme_location'  => 'top1',
            'depth'           => 2,
    ...
    <div class="top-nav d-flex gap-4 align-items-center">
        <?php
        wp_nav_menu([
            'theme_location'  => 'top2',
            'depth'           => 2,
  ...
  <div class="container-lg">
    <div class="d-flex">
        ...
        <a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand">
            <img src="<?php echo esc_url($logo[0]); ?>" alt="<?php bloginfo('name'); ?>" class="navbar-logo-img">
        </a>
        <?php else : ?>
        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>"><?php bloginfo('name'); ?></a>
        <?php endif; ?>

        <div class="d-flex align-items-center language-selector d-lg-none language-selector-mobile">
            <svg class="language-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"></circle><path d="M2 12h20" stroke="currentColor" stroke-width="2"></path><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" stroke="currentColor" stroke-width="2"></path></svg>
            <?php echo do_shortcode( '[language-switcher]' ) ?>
          </div>
    ...
    <div class="primary-nav d-flex gap-3 gap-xxl-3 gap-1">
        <?php
        wp_nav_menu([
    ...
    <div class="d-flex">
        ...
        <a href="<?php echo get_post_type_archive_link('product'); ?>" class="btn btn-primary btn-shop typing-btn d-none d-lg-flex">
        ...
        <div class="">
            <a href="<?php echo wc_get_cart_url(); ?>" class="cart-icon cart-link ms-lg-3 position-relative d-flex align-items-center group" title="Koszyk">
        ...
        <button class="btn btn-outline-none hamburger-btn ms-2 d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileMenu" aria-controls="mobileMenu">
            <svg class="navbar-toggler-icon-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5h16"></path><path d="M4 12h16"></path><path d="M4 19h16"></path></svg>
        </button>
...
<div class="offcanvas offcanvas-end offcanvas-mobile" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
  <div class="offcanvas-header">
        <?php if (has_custom_logo()) :
        $custom_logo_id = get_theme_mod('custom_logo');
        $logo = wp_get_attachment_image_src($custom_logo_id, 'full'); ?>
        <a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand">
            <img src="<?php echo esc_url($logo[0]); ?>" alt="<?php bloginfo('name'); ?>" class="offcanvas-logo-img">
        </a>
        <?php else : ?>
        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>"><?php bloginfo('name'); ?></a>
        <?php endif; ?>
  ...
  <div class="offcanvas-body mobile-menu">
    ...
    <hr class="mobile-nav-divider">
        ...
        <a href="<?php echo get_post_type_archive_link('product'); ?>" class="btn btn-primary btn-shop btn-mobile-menu">
            SKLEP ONLINE
        </a>
